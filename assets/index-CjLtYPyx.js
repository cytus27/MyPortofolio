...
void main() {
	...
	`}var Ea=class extends wt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ir(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
  ...
  `),e.addEventListener(`click`,t=>{t.stopPropagation(),Hc(e,t)}),window.innerWidth>768&&(e.addEventListener(`mousemove`,t=>{let n=e.getBoundingClientRect(),r=n.left+n.width/2,i=n.top+n.height/2,a=(t.clientX-r)/(n.width/2),o=(t.clientY-i)/(n.height/2);e.querySelector(`.hero-photo-inner`).style.transform=`perspective(600px) rotateY(${a*8}deg) rotateX(${-o*8}deg) scale(1.02)`}),e.addEventListener(`mouseleave`,()=>{e.querySelector(`.hero-photo-inner`).style.transform=``})))}function Hc(e,t){Lc++;let n=e.getBoundingClientRect(),r=t.clientX-n.left,i=t.clientY-n.top;Kc(e,r,i);let a=Ic>=3?5:Ic>=2?4:Ic>=1?3:2;for(let t=0;t<a;t++)setTimeout(()=>qc(e,r,i,t,a),t*60);let o=(Ic+1)*100;Rc+=o,zc+=a,Gc(),Jc(e,r,i,`+${o}`),Ac(),Lc%5==0&&Ic<Fc.length-1&&Uc(e),Ic===3&&!Bc&&(Bc=setTimeout(()=>Wc(e),5e3)),Oc+=o,Dc+=a;let s=document.getElementById(`hud-score`),c=document.getElementById(`hud-coins`);s&&(s.textContent=String(Oc).padStart(6,`0`)),c&&(c.textContent=String(Dc).padStart(2,`0`))}function Uc(e){Fc.forEach(t=>{t.cls&&e.classList.remove(t.cls)}),Ic++;let t=Fc[Ic];t.cls&&e.classList.add(t.cls);let n=document.createElement(`div`);n.className=`photo-powerup-banner`,n.innerHTML=`<span>${t.emoji}<br>${t.msg}</span>`,e.appendChild(n),Mc(),setTimeout(()=>n.remove(),1200);let r=document.getElementById(`photo-stage-label`);r&&(r.textContent=`▶ ${t.name} MODE`),e.classList.add(`game-active`)}function Wc(e){Bc=null,Fc.forEach(t=>{t.cls&&e.classList.remove(t.cls)}),Ic=0,Lc=0;let t=document.getElementById(`photo-stage-label`);t&&(t.textContent=`▶ WORLD 1-1`)}function Gc(){let e=document.getElementById(`photo-score`),t=document.getElementById(`photo-coins`);e&&(e.textContent=String(Rc).padStart(6,`0`)),t&&(t.textContent=`🪙×${String(zc).padStart(2,`0`)}`)}function Kc(e,t,n){let r=document.createElement(`div`);r.className=`photo-shockwave`,r.style.left=`${t}px`,r.style.top=`${n}px`,e.appendChild(r),setTimeout(()=>r.remove(),500)}function qc(e,t,n,r,i){let a=document.createElement(`div`);a.className=`photo-coin`,a.textContent=`🪙`;let o=(r/i*360+Math.random()*40-20)*(Math.PI/180),s=Math.sin(o)*(30+Math.random()*20);a.style.left=`${t}px`,a.style.top=`${n}px`,a.style.setProperty(`--dx`,`${s}px`),e.appendChild(a),setTimeout(()=>a.remove(),900)}function Jc(e,t,n,r){let i=document.createElement(`div`);i.className=`photo-score-pop`,i.textContent=r,i.style.left=`${t}px`,i.style.top=`${n}px`,e.appendChild(i),setTimeout(()=>i.remove(),1e3)}function Yc(){let e=document.getElementById(`theme-toggle`);(localStorage.getItem(`mario_portfolio_theme`)||`mario`)===`mario`?(document.body.classList.add(`theme-mario`),e&&(e.innerHTML=`⚡ Dark Mode`)):(document.body.classList.remove(`theme-mario`),e&&(e.innerHTML=`🎮 Mario Mode`)),e&&e.addEventListener(`click`,()=>{Mc(),document.body.classList.toggle(`theme-mario`)?(localStorage.setItem(`mario_portfolio_theme`,`mario`),e.innerHTML=`⚡ Dark Mode`):(localStorage.setItem(`mario_portfolio_theme`,`dark`),e.innerHTML=`🎮 Mario Mode`)})}var Xc=!1,Zc=null,$={E5:659.25,E4:329.63,G5:783.99,G4:392,C5:523.25,A4:440,B4:493.88,Bb4:466.16,F5:698.46,A5:880,D5:587.33,Eb5:622.25,Db5:554.37,C4:261.63,F4:349.23,D4:293.66,Eb4:311.13,Ab4:415.3,Gb4:369.99,SILENT:0},Qc=[[$.E5,1],[$.E5,1],[$.SILENT,1],[$.E5,1],[$.SILENT,1],[$.C5,1],[$.E5,2],[$.G5,2],[$.SILENT,2],[$.G4,2],[$.SILENT,2],[$.C5,2],[$.SILENT,1],[$.G4,2],[$.SILENT,1],[$.E4,2],[$.SILENT,1],[$.A4,2],[$.B4,2],[$.Bb4,1],[$.A4,2],[$.G4,1.33],[$.E5,1.33],[$.G5,1.33],[$.A5,2],[$.F5,1],[$.G5,1],[$.SILENT,1],[$.E5,2],[$.C5,1],[$.D5,1],[$.B4,2],[$.C5,2],[$.SILENT,1],[$.G4,2],[$.SILENT,1],[$.E4,2],[$.SILENT,1],[$.A4,2],[$.B4,2],[$.Bb4,1],[$.A4,2],[$.G4,1.33],[$.E5,1.33],[$.G5,1.33],[$.A5,2],[$.F5,1],[$.G5,1],[$.SILENT,1],[$.E5,2],[$.C5,1],[$.D5,1],[$.B4,2],[$.SILENT,2],[$.G5,1],[$.Fs5||$.Gb4,1],[$.F5,1],[$.Eb5,2],[$.E5,1],[$.SILENT,1],[$.Ab4,1],[$.A4,1],[$.C5,1],[$.SILENT,1],[$.A4,1],[$.C5,1],[$.D5,1],[$.SILENT,2],[$.G5,1],[$.Gb4,1],[$.F5,1],[$.Eb5,2],[$.E5,1],[$.SILENT,1],[$.C6||$.C5,2],[$.C6||$.C5,1],[$.C6||$.C5,2]];function $c(e,t){if(e!==0)try{let n=kc();if(!n)return;let r=n.currentTime,i=n.createOscillator(),a=n.createGain();i.type=`square`,i.frequency.setValueAtTime(e,r),a.gain.setValueAtTime(.08,r),a.gain.exponentialRampToValueAtTime(.001,r+t/1e3*.9),i.connect(a),a.connect(n.destination),i.start(r),i.stop(r+t/1e3)}catch(e){console.error(`Music play error`,e)}}function el(){let e=document.getElementById(`music-toggle`),t=e?e.querySelector(`.music-box-status`):null,n=e?e.querySelector(`.music-box-block`):null,r=e?e.querySelector(`.music-box-note`):null;Xc?(nl(),e&&e.classList.remove(`playing`),t&&(t.textContent=`OFF`),n&&(n.textContent=`?`),r&&(r.textContent=`🎵`)):(tl(),e&&e.classList.add(`playing`),t&&(t.textContent=`ON`),n&&(n.textContent=`🎶`),r&&(r.textContent=`🔊`))}function tl(){if(Xc)return;Xc=!0;let e=0;function t(){if(!Xc)return;let[n,r]=Qc[e],i=r*150;$c(n,i),e=(e+1)%Qc.length,Zc=setTimeout(t,i)}t()}function nl(){Xc=!1,Zc&&=(clearTimeout(Zc),null)}function rl(){let e=document.getElementById(`music-toggle`);e&&e.addEventListener(`click`,()=>{Mc(),el()})}function il(){Nc(),Pc(),Yc(),rl(),Vc()}document.addEventListener(`DOMContentLoaded`,()=>{fc(),pc(),xc(),il()});